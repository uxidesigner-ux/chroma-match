...
PRIMARY = [
    # Wide diagonal bang: part → left forehead → temple. Stays above the
    # eyes, then turns to the side as one sheet, not a visor of thin tips.
    (
        "lock_p_bang",
        [
            PART,
        ...
        [0.40, 0.62, 0.74, 0.68, 0.56, 0.50, 0.48, 0.38, 0.24, 0.14],
        0.94,
        [0.25, 0.85, 1.15, 0.70, 0.22, 0.08, 0.06, 0.04, 0.03, 0.02],
    ),
